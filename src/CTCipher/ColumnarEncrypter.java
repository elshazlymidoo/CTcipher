...
//----------------------------------------------------------------------------- 
    ...
    private static String toCipherTextString(char[][] charArray) {
        StringBuilder cipherText = new StringBuilder();

        for (int col = 0; col < noOfColumns; col++) {
            for (int row = 0; row < noOfRows; row++) {
                cipherText.append(charArray[row][col]);
            }
        }
...
//divides the string in blocks ; takes each block and ciphers it ; then appends each cipher block to a StringBuilder obj. 
    ...
    public static String toCipherText(String plainText) {
        ...
        do {
            ...
            cipherText.append(toCipherTextString(charArray));
